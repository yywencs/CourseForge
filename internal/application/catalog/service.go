...
func (s *Service) ListRounds(ctx context.Context, termID uint64) ([]SelectionRoundView, error) {
	return s.repository.ListRounds(ctx, termID)
}

func (s *Service) CreateRound(ctx context.Context, input SelectionRoundCommand) (*domain.SelectionRound, error) {
	round, err := domain.NewSelectionRound(input.plan())
	if err != nil {
		return nil, err
	}
	if err := s.repository.WithinTransaction(ctx, func(txCtx context.Context) error {
...
func (s *Service) UpdateRound(ctx context.Context, id uint64, input SelectionRoundCommand) (*domain.SelectionRound, error) {
	var round *domain.SelectionRound
	err := s.repository.WithinTransaction(ctx, func(txCtx context.Context) error {
...
func (s *Service) DeleteRound(ctx context.Context, id uint64) error {
	return s.repository.WithinTransaction(ctx, func(txCtx context.Context) error {
...
func (s *Service) ListRoundClasses(ctx context.Context, roundID uint64) ([]RoundClassBindingView, error) {
	return s.repository.ListRoundClasses(ctx, roundID)
}

func (s *Service) BindRoundClass(ctx context.Context, roundID, teachingClassID uint64) error {
	return s.repository.WithinTransaction(ctx, func(txCtx context.Context) error {
		round, err := s.repository.GetRoundForUpdate(txCtx, roundID)
		if err != nil {
			return err
		}
		class, err := s.repository.GetTeachingClassForUpdate(txCtx, teachingClassID)
		if err != nil {
			return err
		}
		if err := round.EnsureCanBind(*class); err != nil {
			return err
		}
...
func (s *Service) UnbindRoundClass(ctx context.Context, roundID, teachingClassID uint64) error {
	return s.repository.WithinTransaction(ctx, func(txCtx context.Context) error {
		round, err := s.repository.GetRoundForUpdate(txCtx, roundID)
		if err != nil {
			return err
