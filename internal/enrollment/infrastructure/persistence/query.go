...
func (r *QueryStore) querySelectionByRequestFromMySQL(
	ctx context.Context,
	roundID uint64,
	studentID uint64,
	requestID string,
...
func (r *QueryStore) QuerySelectionRound(
	ctx context.Context,
	roundID uint64,
...
func (r *QueryStore) QueryTeachingClass(
	ctx context.Context,
	roundID uint64,
	teachingClassID uint64,
...
func (r *QueryStore) QueryStudentSelectionQuota(
	ctx context.Context,
	roundID uint64,
	studentID uint64,
...
func (r *QueryStore) IsStudentActive(ctx context.Context, studentID uint64) (bool, error) {
	if studentID == 0 {
...
func (r *QueryStore) HasExistingEnrollment(
	ctx context.Context,
	termID uint64,
	studentID uint64,
	courseID uint64,
