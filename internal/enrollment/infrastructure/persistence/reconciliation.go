...
func (r *RepairStore) QueryPendingProjectionRepairs(
	ctx context.Context,
	now time.Time,
	limit int,
...
func (r *RepairStore) MarkProjectionRepairCompleted(
	ctx context.Context,
	repairID string,
...
func (r *RepairStore) MarkProjectionRepairFailed(
	ctx context.Context,
	repairID string,
	retryAt time.Time,
	lastError string,
...
func (r *RepairStore) CountPendingProjectionRepairs(ctx context.Context) (int64, error) {
	var count int64
