...
func (r *WaitlistStore) JoinWaitlist(
	ctx context.Context,
...
func (r *WaitlistStore) QueryWaitlist(
	ctx context.Context,
	waitlistID string,
	studentID uint64,
) (*enrollment.WaitlistEntry, error) {
...
func (r *WaitlistStore) queryWaitlistByRequest(
	ctx context.Context,
	roundID uint64,
	studentID uint64,
	requestID string,
...
func (r *WaitlistStore) ListStudentWaitlist(
	ctx context.Context,
	studentID uint64,
	termID uint64,
	limit int,
...
func (r *WaitlistStore) CancelWaitlist(ctx context.Context, entry *enrollment.WaitlistEntry) error {
...
func (r *WaitlistStore) ClaimPromotableEntries(
	ctx context.Context,
	now time.Time,
	limit int,
) ([]*enrollment.WaitlistEntry, error) {
...
func (r *WaitlistStore) ClaimExpiredEntries(
	ctx context.Context,
	now time.Time,
	limit int,
) ([]*enrollment.WaitlistEntry, error) {
...
func (r *WaitlistStore) MarkWaitlistPromoted(ctx context.Context, entry *enrollment.WaitlistEntry) error {
...
func (r *WaitlistStore) ReturnWaitlistToQueue(ctx context.Context, entry *enrollment.WaitlistEntry) error {
