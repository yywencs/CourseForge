...
type eventPublisher interface {
	Publish(ctx context.Context, topic string, event *BaseEvent) error
}

type publisherSlot interface {
	publish(ctx context.Context, topic string, event *BaseEvent, body []byte) error
	close() error
}
...
func (p *RabbitMQPublisher) Publish(ctx context.Context, topic string, event *BaseEvent) error {
...
func (s *amqpPublisherSlot) publish(ctx context.Context, topic string, event *BaseEvent, body []byte) error {
