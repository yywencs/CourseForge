...
func (s *Server) JoinWaitlist(c *gin.Context) {
...
func (s *Server) QueryWaitlist(c *gin.Context) {
	studentID, ok := authenticatedStudentID(c)
	if !ok {
		return
	}
...
func (s *Server) ListMyWaitlist(c *gin.Context) {
	studentID, ok := authenticatedStudentID(c)
	if !ok {
		return
	}
...
func (s *Server) CancelWaitlist(c *gin.Context) {
	studentID, ok := authenticatedStudentID(c)
	if !ok {
		return
	}
